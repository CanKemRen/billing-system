...
/**
 * Used by the {@code org.springframework.batch.item.excel.AbstractExcelItemReader} to abstract away the complexities of the underlying Excel API
 * implementations.
 *
...
public interface RowSet {
	 ...
	 *             if the column name meta data is not available.
	 */
