...
/**
 * {@code RowSetFactory} implementation which constructs a {@code DefaultRowSet} instance and {@code DefaultRowSetMetaData} instance. The latter will have the
 * {@code ColumnNameExtractor} configured on this factory set (default {@code RowNumberColumnNameExtractor}.
 *
