...
/**
 * {@link org.springframework.batch.item.ItemReader} implementation to read an Excel file. It will read the file sheet for sheet and row for row. It is loosy
...
public abstract class AbstractExcelItemReader<T> extends AbstractItemCountingItemStreamItemReader<T> implements
	...
	protected abstract void openExcelFile(String path, String filename) throws Exception;
